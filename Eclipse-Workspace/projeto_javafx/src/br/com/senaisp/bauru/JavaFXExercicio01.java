...
public class JavaFXExercicio01 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
        ...
        Scene cena = new Scene(noRoot,400,400,Color.DARKGRAY);
	...
	private void criarComponentes(Group noRoot) {
		HBox cmp01 =new HBox();
		Rectangle cmp02 = new Rectangle(400,100,Color.BLUE);
		...
		Button btn02 = new Button("Julian Alvarez");
		Button btn03 = new Button("CRistiano Ronaldo");
